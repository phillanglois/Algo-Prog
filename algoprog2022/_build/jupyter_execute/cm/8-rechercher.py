...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Rechercher" data-toc-modified-id="Rechercher-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Rechercher</a></span></li><li><span><a href="#Objectif-du-chapitre" data-toc-modified-id="Objectif-du-chapitre-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Objectif du chapitre</a></span><ul class="toc-item"><li><span><a href="#Recherche-séquentielle" data-toc-modified-id="Recherche-séquentielle-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>Recherche séquentielle</a></span><ul class="toc-item"><li><span><a href="#Principes" data-toc-modified-id="Principes-2.1.1"><span class="toc-item-num">2.1.1&nbsp;&nbsp;</span>Principes</a></span></li><li><span><a href="#Algorithmes-itératifs" data-toc-modified-id="Algorithmes-itératifs-2.1.2"><span class="toc-item-num">2.1.2&nbsp;&nbsp;</span>Algorithmes itératifs</a></span><ul class="toc-item"><li><span><a href="#Parcours-complet" data-toc-modified-id="Parcours-complet-2.1.2.1"><span class="toc-item-num">2.1.2.1&nbsp;&nbsp;</span>Parcours complet</a></span></li><li><span><a href="#Parcours-minimal" data-toc-modified-id="Parcours-minimal-2.1.2.2"><span class="toc-item-num">2.1.2.2&nbsp;&nbsp;</span>Parcours minimal</a></span></li><li><span><a href="#Cas-du-tableau-vide" data-toc-modified-id="Cas-du-tableau-vide-2.1.2.3"><span class="toc-item-num">2.1.2.3&nbsp;&nbsp;</span>Cas du tableau vide</a></span></li></ul></li><li><span><a href="#Algorithme-récursif" data-toc-modified-id="Algorithme-récursif-2.1.3"><span class="toc-item-num">2.1.3&nbsp;&nbsp;</span>Algorithme récursif</a></span></li></ul></li><li><span><a href="#Recherche-dichotomique-dans-un-tableau-trié" data-toc-modified-id="Recherche-dichotomique-dans-un-tableau-trié-2.2"><span class="toc-item-num">2.2&nbsp;&nbsp;</span>Recherche dichotomique dans un tableau trié</a></span><ul class="toc-item"><li><span><a href="#Principes" data-toc-modified-id="Principes-2.2.1"><span class="toc-item-num">2.2.1&nbsp;&nbsp;</span>Principes</a></span></li><li><span><a href="#Algorithme-itératif" data-toc-modified-id="Algorithme-itératif-2.2.2"><span class="toc-item-num">2.2.2&nbsp;&nbsp;</span>Algorithme itératif</a></span></li><li><span><a href="#Algorithme-récursif" data-toc-modified-id="Algorithme-récursif-2.2.3"><span class="toc-item-num">2.2.3&nbsp;&nbsp;</span>Algorithme récursif</a></span></li></ul></li><li><span><a href="#Complexité-des-algorithmes-de-recherche" data-toc-modified-id="Complexité-des-algorithmes-de-recherche-2.3"><span class="toc-item-num">2.3&nbsp;&nbsp;</span>Complexité des algorithmes de recherche</a></span><ul class="toc-item"><li><span><a href="#Les-paramètres-de-l'analyse-de-la-complexité" data-toc-modified-id="Les-paramètres-de-l'analyse-de-la-complexité-2.3.1"><span class="toc-item-num">2.3.1&nbsp;&nbsp;</span>Les paramètres de l'analyse de la complexité</a></span></li><li><span><a href="#Analyse-de-la-recherche-séquentielle-itérative" data-toc-modified-id="Analyse-de-la-recherche-séquentielle-itérative-2.3.2"><span class="toc-item-num">2.3.2&nbsp;&nbsp;</span>Analyse de la recherche séquentielle itérative</a></span></li><li><span><a href="#Analyse-de-la-recherche-dichotomique,-version-itérative" data-toc-modified-id="Analyse-de-la-recherche-dichotomique,-version-itérative-2.3.3"><span class="toc-item-num">2.3.3&nbsp;&nbsp;</span>Analyse de la recherche dichotomique, version itérative</a></span></li><li><span><a href="#Analyse-de-la-recherche-dichotomique,-version-récursive" data-toc-modified-id="Analyse-de-la-recherche-dichotomique,-version-récursive-2.3.4"><span class="toc-item-num">2.3.4&nbsp;&nbsp;</span>Analyse de la recherche dichotomique, version récursive</a></span></li></ul></li><li><span><a href="#($\star$)-Preuves-de-terminaison-et-de-correction" data-toc-modified-id="($\star$)-Preuves-de-terminaison-et-de-correction-2.4"><span class="toc-item-num">2.4&nbsp;&nbsp;</span>($\star$) Preuves de terminaison et de correction</a></span><ul class="toc-item"><li><span><a href="#Terminaison-de-la-recherche-séquentielle-:-version-itérative" data-toc-modified-id="Terminaison-de-la-recherche-séquentielle-:-version-itérative-2.4.1"><span class="toc-item-num">2.4.1&nbsp;&nbsp;</span>Terminaison de la recherche séquentielle : version itérative</a></span></li><li><span><a href="#Correction-de-la-recherche-séquentielle-:--version-itérative" data-toc-modified-id="Correction-de-la-recherche-séquentielle-:--version-itérative-2.4.2"><span class="toc-item-num">2.4.2&nbsp;&nbsp;</span>Correction de la recherche séquentielle :  version itérative</a></span></li><li><span><a href="#Terminaison-de-la-recherche-dichotomique" data-toc-modified-id="Terminaison-de-la-recherche-dichotomique-2.4.3"><span class="toc-item-num">2.4.3&nbsp;&nbsp;</span>Terminaison de la recherche dichotomique</a></span></li><li><span><a href="#($\star\star$)-Correction-de-la-recherche-dichotomique-:-version-itérative" data-toc-modified-id="($\star\star$)-Correction-de-la-recherche-dichotomique-:-version-itérative-2.4.4"><span class="toc-item-num">2.4.4&nbsp;&nbsp;</span>($\star\star$) Correction de la recherche dichotomique : version itérative</a></span></li></ul></li><li><span><a href="#Synthèse" data-toc-modified-id="Synthèse-2.5"><span class="toc-item-num">2.5&nbsp;&nbsp;</span>Synthèse</a></span></li></ul></li></ul></div>
...
# 
# Au delà de la question de la recherche de valeur dans un ensemble, l'objectif central de ce chapitre est de _construire des versions itératives et récursives d'un **même algorithme**_.  
# 
# L'analyse de la complexité de ces traitements sera aussi réalisée ainsi qu'une illustration de preuve de terminaison et de correction de ces traitements.
# 
...
# ##### En-tête générique de la fonction
# 
# _En-tête générique_ : cet en-tête est à la fois suffisamment général pour définir différents algorithmes de traitement (qui résolvent notre problème, ici la recherche d'une valeur dans un ensemble) et suffisamment précis pour être la spécification complète de tous ces cas.
...
#     - _tab_ : le tableau 1D qui contient les valeurs -- ici u tableau 1D représenté par une liste python 
#     - _dim_ : `len(tab)` le nombre de valeurs  
# 
# - sortie :
#     - booléen : _True_ ou _False_ 

# En pratique, cet en-tête est un _modèle_ d'en-tête qui peut être modifié de façon minime pour spécifier la fonction qui (ici) effectue recherche de valeur de type différent (ici des `int`), dans un ensemble représenté autrement (qu'ici, un tableau 1D).  
# 
# On peut voir _le type des valeurs_ et _la structure de stockage_ comme des paramètres de plus haut niveau d'abstraction de ce traitement.  Ceci correspond à la notion de _généricité_ ou de certaines formes de la notion d'héritage dans les langages (dits) objet. 
