...
# 
# version 2021, PhL, v1.3

# <h1>Table des matières<span class="tocSkip"></span></h1>
# <div class="toc"><ul class="toc-item"><li><span><a href="#Boucles,-tableaux-et-fonctions-:-compléments" data-toc-modified-id="Boucles,-tableaux-et-fonctions-:-compléments-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Boucles, tableaux et fonctions : compléments</a></span><ul class="toc-item"><li><span><a href="#Tableaux" data-toc-modified-id="Tableaux-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Tableaux</a></span><ul class="toc-item"><li><span><a href="#Vocabulaire" data-toc-modified-id="Vocabulaire-1.1.1"><span class="toc-item-num">1.1.1&nbsp;&nbsp;</span>Vocabulaire</a></span></li><li><span><a href="#Tableaux-en-python" data-toc-modified-id="Tableaux-en-python-1.1.2"><span class="toc-item-num">1.1.2&nbsp;&nbsp;</span>Tableaux en python</a></span></li><li><span><a href="#Tableaux-multidimensionnels-représentés-avec-des-listes" data-toc-modified-id="Tableaux-multidimensionnels-représentés-avec-des-listes-1.1.3"><span class="toc-item-num">1.1.3&nbsp;&nbsp;</span>Tableaux multidimensionnels représentés avec des listes</a></span></li><li><span><a href="#Pas-de-[-]*-pour-définir-une-liste-multidimensionnelle" data-toc-modified-id="Pas-de-[-]*-pour-définir-une-liste-multidimensionnelle-1.1.4"><span class="toc-item-num">1.1.4&nbsp;&nbsp;</span>Pas de <code>[ ]*</code> pour définir une liste multidimensionnelle</a></span></li></ul></li><li><span><a href="#Spécifications-de-fonctions-avec-paramètre-List--en-python" data-toc-modified-id="Spécifications-de-fonctions-avec-paramètre-List--en-python-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Spécifications de fonctions avec paramètre <code>List</code>  en python</a></span><ul class="toc-item"><li><span><a href="#Comment-indiquer-le-type-d'un-paramètre-formel-d'une-fonction-lorsque-celui-ci-est-une-liste-?" data-toc-modified-id="Comment-indiquer-le-type-d'un-paramètre-formel-d'une-fonction-lorsque-celui-ci-est-une-liste-?-1.2.1"><span class="toc-item-num">1.2.1&nbsp;&nbsp;</span>Comment indiquer le type d'un paramètre formel d'une fonction lorsque celui-ci est une liste ?</a></span></li><li><span><a href="#Comment-spécifier-une-fonction-avec-des-paramètres-formels-de-type-tableau-?" data-toc-modified-id="Comment-spécifier-une-fonction-avec-des-paramètres-formels-de-type-tableau-?-1.2.2"><span class="toc-item-num">1.2.2&nbsp;&nbsp;</span>Comment spécifier une fonction avec des paramètres formels de type tableau ?</a></span></li><li><span><a href="#($\star\star$)-Quelle-spécification-pour-une-fonction-générique-?-{#genericite}" data-toc-modified-id="($\star\star$)-Quelle-spécification-pour-une-fonction-générique-?-{#genericite}-1.2.3"><span class="toc-item-num">1.2.3&nbsp;&nbsp;</span>($\star\star$) Quelle spécification pour une fonction générique ? {#genericite}</a></span><ul class="toc-item"><li><span><a href="#Généricité" data-toc-modified-id="Généricité-1.2.3.1"><span class="toc-item-num">1.2.3.1&nbsp;&nbsp;</span>Généricité</a></span></li><li><span><a href="#Union-dans-le-module-typing" data-toc-modified-id="Union-dans-le-module-typing-1.2.3.2"><span class="toc-item-num">1.2.3.2&nbsp;&nbsp;</span><code>Union</code> dans le module <code>typing</code></a></span></li><li><span><a href="#A-lire" data-toc-modified-id="A-lire-1.2.3.3"><span class="toc-item-num">1.2.3.3&nbsp;&nbsp;</span>A lire</a></span></li></ul></li></ul></li><li><span><a href="#Boucles-imbriquées" data-toc-modified-id="Boucles-imbriquées-1.3"><span class="toc-item-num">1.3&nbsp;&nbsp;</span>Boucles imbriquées</a></span><ul class="toc-item"><li><span><a href="#Le-contexte" data-toc-modified-id="Le-contexte-1.3.1"><span class="toc-item-num">1.3.1&nbsp;&nbsp;</span>Le contexte</a></span></li><li><span><a href="#min1()" data-toc-modified-id="min1()-1.3.2"><span class="toc-item-num">1.3.2&nbsp;&nbsp;</span><code>min1()</code></a></span></li><li><span><a href="#min2()" data-toc-modified-id="min2()-1.3.3"><span class="toc-item-num">1.3.3&nbsp;&nbsp;</span><code>min2()</code></a></span></li><li><span><a href="#Comptons--1,-2,-3,-..." data-toc-modified-id="Comptons--1,-2,-3,-...-1.3.4"><span class="toc-item-num">1.3.4&nbsp;&nbsp;</span>Comptons  1, 2, 3, ...</a></span></li><li><span><a href="#Imbriquons-trois-boucles-!" data-toc-modified-id="Imbriquons-trois-boucles-!-1.3.5"><span class="toc-item-num">1.3.5&nbsp;&nbsp;</span>Imbriquons trois boucles !</a></span></li></ul></li><li><span><a href="#Boucles-imbriquées-dépendantes" data-toc-modified-id="Boucles-imbriquées-dépendantes-1.4"><span class="toc-item-num">1.4&nbsp;&nbsp;</span>Boucles imbriquées dépendantes</a></span><ul class="toc-item"><li><span><a href="#Valeur-répétée-dans-un-tableau-1D" data-toc-modified-id="Valeur-répétée-dans-un-tableau-1D-1.4.1"><span class="toc-item-num">1.4.1&nbsp;&nbsp;</span>Valeur répétée dans un tableau 1D</a></span></li><li><span><a href="#Une-première-solution-avec-deux-boucles-imbriquées-indépendantes" data-toc-modified-id="Une-première-solution-avec-deux-boucles-imbriquées-indépendantes-1.4.2"><span class="toc-item-num">1.4.2&nbsp;&nbsp;</span>Une première solution avec deux boucles imbriquées indépendantes</a></span></li><li><span><a href="#Une-solution-avec-deux-boucles-imbriquées-dépendantes" data-toc-modified-id="Une-solution-avec-deux-boucles-imbriquées-dépendantes-1.4.3"><span class="toc-item-num">1.4.3&nbsp;&nbsp;</span>Une solution avec deux boucles imbriquées dépendantes</a></span></li></ul></li><li><span><a href="#Autres-imbrications-de-boucles" data-toc-modified-id="Autres-imbrications-de-boucles-1.5"><span class="toc-item-num">1.5&nbsp;&nbsp;</span>Autres imbrications de boucles</a></span></li><li><span><a href="#Synthèse" data-toc-modified-id="Synthèse-1.6"><span class="toc-item-num">1.6&nbsp;&nbsp;</span>Synthèse</a></span><ul class="toc-item"><li><span><a href="#Ce-qui-a-été-vu" data-toc-modified-id="Ce-qui-a-été-vu-1.6.1"><span class="toc-item-num">1.6.1&nbsp;&nbsp;</span>Ce qui a été vu</a></span></li><li><span><a href="#Ce-qu'il-faut-savoir" data-toc-modified-id="Ce-qu'il-faut-savoir-1.6.2"><span class="toc-item-num">1.6.2&nbsp;&nbsp;</span>Ce qu'il faut savoir</a></span></li><li><span><a href="#Ce-qu'il-faut-savoir-faire" data-toc-modified-id="Ce-qu'il-faut-savoir-faire-1.6.3"><span class="toc-item-num">1.6.3&nbsp;&nbsp;</span>Ce qu'il faut savoir faire</a></span></li><li><span><a href="#Exercice-de-synthèse" data-toc-modified-id="Exercice-de-synthèse-1.6.4"><span class="toc-item-num">1.6.4&nbsp;&nbsp;</span>Exercice de synthèse</a></span></li></ul></li></ul></li></ul></div>
...
# 
# **Comment définir un tableau multidimentionnel représenté avec une liste de listes de ... ?**

# **- Ce qu'il ne faut pas faire :**
# 
# On pourrait _être tenté_ d'écrire : 
# 
# ```python 
# 
# c = [[0] * n] * n
...
# **- Ce qu'il faut faire :**
# 
# On utilisera systématiquement la _construction d'une liste par compréhension_.
# 
# ```python 
# 
...
# Cette  _très mauvaise idée_ est pourtant encore sans conséquence visible avec des affichages ou des tests trop naifs !
...
# 
# Ce type de comportement est vraiment piégeux et particulièrement long à débugger ...
# Moralité :
# 1. Comprendre : 1 fois
# 2. S'interdire tout risque : systématiquement !
...
#     <ul>
#     <li> 1D : OUI à '[i for i in range(3)]</li>
#     <li> 2D : OUI à '[[0 for i in range(3)] for j in range(5)]'</li>
#     </ul>
# <li>Ne pas utiliser le symbole '*' de concaténation répétée pour créer et initialiser une liste.</li>
#     <ul>
#     <li> NON à '[[0] * 3] * 5'</li>
#     </ul>
# </ul>    
...
#     - il suffit d'appeler la fonction pour des paramètres bien choisis -- cad. pour lesquels le traitements attendu est connu.
...
# 
# Par exemple pour la spécification de la fonction qui identifie et retourne la valeur minimale dans un tableau 2D s'écrit par exemple (pour un tableau 2D d'entiers) :
# 
# ```python
...
# ### ($\star\star$) Quelle spécification pour une fonction générique ? {#genericite}
# 
...
# 
# 
# _Dans certains cas_, il est nécessaire de parcourir deux fois le tableau $t$ (entièrement ou presque) pour pouvoir répondre (oui ou non) à cette question.  
...
# Un algorithme _correct_, cad. un algorithme qui répond correctement à cette question _pour n'importe quel tableau_,  devra donc _pouvoir_ effectuer ces deux parcours.  
...
# 
# 
# **Exercice.** Modifier la question (Q) pour que son traitement demande alors que les deux parcours du tableau ne soient pas interrompus.   
...
# - Le schéma suivant aide à comprendre ce traitement.![prod_mat](./img/prod_mat.png)
...
# **Structure de données complexe : les tableaux et leur représentation** les tableaux de dimension quelconque peuvent être représentés en python par des listes, des listes de listes, des listes de listes de listes ... 
# 
