...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Sous-programme-et-affectation----aspects-avancés" data-toc-modified-id="Sous-programme-et-affectation----aspects-avancés-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Sous-programme et affectation -- aspects avancés</a></span><ul class="toc-item"><li><span><a href="#Le-passage-des-paramètres-:-un-problème-générique" data-toc-modified-id="Le-passage-des-paramètres-:-un-problème-générique-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Le passage des paramètres : un problème générique</a></span><ul class="toc-item"><li><span><a href="#Comment-est-transmis-un-paramètre-effectif-?" data-toc-modified-id="Comment-est-transmis-un-paramètre-effectif-?-1.1.1"><span class="toc-item-num">1.1.1&nbsp;&nbsp;</span>Comment est transmis un paramètre effectif ?</a></span></li><li><span><a href="#Deux-modes-matériels-de-passage-des-paramètres" data-toc-modified-id="Deux-modes-matériels-de-passage-des-paramètres-1.1.2"><span class="toc-item-num">1.1.2&nbsp;&nbsp;</span>Deux modes <em>matériels</em> de passage des paramètres</a></span></li><li><span><a href="#Trois-modes-logiques-de-passage-des-paramètres" data-toc-modified-id="Trois-modes-logiques-de-passage-des-paramètres-1.1.3"><span class="toc-item-num">1.1.3&nbsp;&nbsp;</span>Trois modes <em>logiques</em> de passage des paramètres</a></span></li></ul></li><li><span><a href="#Et-pour-python-?" data-toc-modified-id="Et-pour-python-?-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Et pour python ?</a></span></li><li><span><a href="#($\star$)-Variable-et-affection-:-aspects-avancés" data-toc-modified-id="($\star$)-Variable-et-affection-:-aspects-avancés-1.3"><span class="toc-item-num">1.3&nbsp;&nbsp;</span>($\star$) Variable et affection : aspects avancés</a></span><ul class="toc-item"><li><span><a href="#Notions-importantes" data-toc-modified-id="Notions-importantes-1.3.1"><span class="toc-item-num">1.3.1&nbsp;&nbsp;</span>Notions importantes</a></span><ul class="toc-item"><li><span><a href="#Variable,-valeur,-espace-de-stockage,-adresse-en-mémoire,-référence" data-toc-modified-id="Variable,-valeur,-espace-de-stockage,-adresse-en-mémoire,-référence-1.3.1.1"><span class="toc-item-num">1.3.1.1&nbsp;&nbsp;</span>Variable, valeur, espace de stockage, adresse en mémoire, référence</a></span></li><li><span><a href="#Affectation-et-évaluation" data-toc-modified-id="Affectation-et-évaluation-1.3.1.2"><span class="toc-item-num">1.3.1.2&nbsp;&nbsp;</span>Affectation et évaluation</a></span></li><li><span><a href="#Déclaration-vs.-affectation" data-toc-modified-id="Déclaration-vs.-affectation-1.3.1.3"><span class="toc-item-num">1.3.1.3&nbsp;&nbsp;</span>Déclaration <em>vs.</em> affectation</a></span></li></ul></li><li><span><a href="#Variables-et-affectation-en-python" data-toc-modified-id="Variables-et-affectation-en-python-1.3.2"><span class="toc-item-num">1.3.2&nbsp;&nbsp;</span>Variables et affectation en python</a></span><ul class="toc-item"><li><span><a href="#Variables-en-python-:-mutable-ou-non-mutable-?" data-toc-modified-id="Variables-en-python-:-mutable-ou-non-mutable-?-1.3.2.1"><span class="toc-item-num">1.3.2.1&nbsp;&nbsp;</span>Variables en python : mutable ou non mutable ?</a></span></li><li><span><a href="#Dupliquer-des-valeurs-par-référence-:--mutable-vs.-non-mutable" data-toc-modified-id="Dupliquer-des-valeurs-par-référence-:--mutable-vs.-non-mutable-1.3.2.2"><span class="toc-item-num">1.3.2.2&nbsp;&nbsp;</span>Dupliquer des valeurs par référence :  mutable <em>vs.</em> non mutable</a></span></li></ul></li><li><span><a href="#Approfondissons-par-introspection" data-toc-modified-id="Approfondissons-par-introspection-1.3.3"><span class="toc-item-num">1.3.3&nbsp;&nbsp;</span>Approfondissons par <em>introspection</em></a></span><ul class="toc-item"><li><span><a href="#Les-fonctions--type(-)-et-id(-)" data-toc-modified-id="Les-fonctions--type(-)-et-id(-)-1.3.3.1"><span class="toc-item-num">1.3.3.1&nbsp;&nbsp;</span>Les fonctions  <code>type( )</code> et <code>id( )</code></a></span></li><li><span><a href="#Introspection-de-l'affectation" data-toc-modified-id="Introspection-de-l'affectation-1.3.3.2"><span class="toc-item-num">1.3.3.2&nbsp;&nbsp;</span>Introspection de l'affectation</a></span></li></ul></li><li><span><a href="#Affectation-en-python-:-compléments" data-toc-modified-id="Affectation-en-python-:-compléments-1.3.4"><span class="toc-item-num">1.3.4&nbsp;&nbsp;</span>Affectation en python : compléments</a></span><ul class="toc-item"><li><span><a href="#Modification-partielle-vs.-modification-complète-d'un-mutable" data-toc-modified-id="Modification-partielle-vs.-modification-complète-d'un-mutable-1.3.4.1"><span class="toc-item-num">1.3.4.1&nbsp;&nbsp;</span>Modification partielle <em>vs.</em> modification complète d'un mutable</a></span></li><li><span><a href="#Comment-dupliquer-(re-copier)-un-objet-mutable-et-obtenir-2-objets-différents-en-mémoire-?" data-toc-modified-id="Comment-dupliquer-(re-copier)-un-objet-mutable-et-obtenir-2-objets-différents-en-mémoire-?-1.3.4.2"><span class="toc-item-num">1.3.4.2&nbsp;&nbsp;</span>Comment dupliquer (re-copier) un objet mutable et obtenir 2 objets différents en mémoire ?</a></span></li><li><span><a href="#Des-subtilités-pour-x-+=-1-vs.-x-=-x-+-1" data-toc-modified-id="Des-subtilités-pour-x-+=-1-vs.-x-=-x-+-1-1.3.4.3"><span class="toc-item-num">1.3.4.3&nbsp;&nbsp;</span>Des subtilités pour <code>x += 1</code> <em>vs.</em> <code>x = x + 1</code></a></span></li></ul></li></ul></li><li><span><a href="#($\star$)-Fonctions-:-aspects-avancés" data-toc-modified-id="($\star$)-Fonctions-:-aspects-avancés-1.4"><span class="toc-item-num">1.4&nbsp;&nbsp;</span>($\star$) Fonctions : aspects avancés</a></span><ul class="toc-item"><li><span><a href="#Le-paramètre-est-de-type-non-mutable" data-toc-modified-id="Le-paramètre-est-de-type-non-mutable-1.4.1"><span class="toc-item-num">1.4.1&nbsp;&nbsp;</span>Le paramètre est de type non-mutable</a></span></li><li><span><a href="#Le-paramètre-de-type-mutable" data-toc-modified-id="Le-paramètre-de-type-mutable-1.4.2"><span class="toc-item-num">1.4.2&nbsp;&nbsp;</span>Le paramètre de type mutable</a></span></li><li><span><a href="#(Optionnel)-Avoir-les-id-claires-!" data-toc-modified-id="(Optionnel)-Avoir-les-id-claires-!-1.4.3"><span class="toc-item-num">1.4.3&nbsp;&nbsp;</span>(Optionnel) Avoir les <code>id</code> claires !</a></span><ul class="toc-item"><li><span><a href="#Utilisons-les-id()-avec-les-mutables" data-toc-modified-id="Utilisons-les-id()-avec-les-mutables-1.4.3.1"><span class="toc-item-num">1.4.3.1&nbsp;&nbsp;</span>Utilisons les <code>id()</code> avec les mutables</a></span></li><li><span><a href="#Utilisons-les-id()-avec-les-non-mutables" data-toc-modified-id="Utilisons-les-id()-avec-les-non-mutables-1.4.3.2"><span class="toc-item-num">1.4.3.2&nbsp;&nbsp;</span>Utilisons les <code>id()</code> avec les non mutables</a></span></li></ul></li></ul></li><li><span><a href="#Les-fonctions-en-python-:-derniers-compléments-faciles" data-toc-modified-id="Les-fonctions-en-python-:-derniers-compléments-faciles-1.5"><span class="toc-item-num">1.5&nbsp;&nbsp;</span>Les fonctions en python : derniers compléments faciles</a></span><ul class="toc-item"><li><span><a href="#Arguments-nommés" data-toc-modified-id="Arguments-nommés-1.5.1"><span class="toc-item-num">1.5.1&nbsp;&nbsp;</span>Arguments nommés</a></span></li><li><span><a href="#Argument-avec-valeur-par-défaut" data-toc-modified-id="Argument-avec-valeur-par-défaut-1.5.2"><span class="toc-item-num">1.5.2&nbsp;&nbsp;</span>Argument avec valeur par défaut</a></span></li><li><span><a href="#Ce-qu'il-reste-à-voir-sur-les-fonctions-en-python" data-toc-modified-id="Ce-qu'il-reste-à-voir-sur-les-fonctions-en-python-1.5.3"><span class="toc-item-num">1.5.3&nbsp;&nbsp;</span>Ce qu'il reste à voir sur les fonctions en python</a></span></li></ul></li><li><span><a href="#Synthèse" data-toc-modified-id="Synthèse-1.6"><span class="toc-item-num">1.6&nbsp;&nbsp;</span>Synthèse</a></span><ul class="toc-item"><li><span><a href="#Avoir-les-idées-claires" data-toc-modified-id="Avoir-les-idées-claires-1.6.1"><span class="toc-item-num">1.6.1&nbsp;&nbsp;</span>Avoir les idées claires</a></span></li><li><span><a href="#Savoir-faire-en-python" data-toc-modified-id="Savoir-faire-en-python-1.6.2"><span class="toc-item-num">1.6.2&nbsp;&nbsp;</span>Savoir-faire en python</a></span></li></ul></li></ul></li></ul></div>
